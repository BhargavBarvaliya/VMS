...
public class Helper {
    ...
    public static List<Product> convertExcelToListOfProduct(InputStream is) {
        ...
        try {
            ...
            XSSFSheet sheet = workbook.getSheet("random_products_with_details_an");
                ...
                while (cells.hasNext()) {
                    ...
                    switch (cid) {
                        case 0:
                            ...
                            break;
                        case 1:
                            p.setUPC((long) cell.getNumericCellValue());
                            break;
                        case 2:
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            p.setAddedDate(cell.getLocalDateTimeCellValue());
                            break;
                        default:
                            break;
                    }
...
//                Iterable<CSVRecord> csvRecords = csvParser.getRecords();
                ...
                Product p = new Product();
                p.setSKU(data[0]);
                p.setUPC(Long.parseLong(data[1]));
                p.setProductName(data[2]);
                p.setProductPrice(Double.parseDouble(data[3]));
                p.setProductWeight(Double.parseDouble(data[4]));
                p.setProductManufacturer(data[5]);
                p.setProductStocks(Integer.parseInt(data[6]));
